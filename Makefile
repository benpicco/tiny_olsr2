...
node:	node/node.o node/nhdp_reader.o node/nhdp_writer.o node/nhdp.o node/olsr2.o node/olsr2_writer.o $(LDFLAGS)
	cc node/node.o node/nhdp_reader.o node/nhdp_writer.o node/nhdp.o node/olsr2.o node/olsr2_writer.o $(LDFLAGS) -o node/node
