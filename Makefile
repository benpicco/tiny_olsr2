...
node:	node/main.o node/reader.o node/writer.o node/nhdp.o node/olsr.o node/util.o $(LDFLAGS)
	cc node/main.o node/reader.o node/writer.o node/nhdp.o node/olsr.o node/util.o $(LDFLAGS) -o node/node
