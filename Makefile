...
node:	node/node.o node/reader.o node/writer.o node/nhdp.o node/duplicate.o $(LDFLAGS)
	cc node/node.o node/reader.o node/writer.o node/nhdp.o node/duplicate.o $(LDFLAGS) -o node/node
