...
node:	node/node.o node/nhdp_reader.o node/nhdp_writer.o node/nhdp.o $(LDFLAGS)
	cc node/node.o node/nhdp_reader.o node/nhdp_writer.o node/nhdp.o $(LDFLAGS) -o node/node
