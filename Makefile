...
node:	node/node.o node/reader.o node/writer.o node/nhdp.o node/duplicate.o node/misc.o $(LDFLAGS)
	cc node/node.o node/reader.o node/writer.o node/nhdp.o node/duplicate.o node/misc.o $(LDFLAGS) -o node/node
